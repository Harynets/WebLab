    ...
    return (
        <div className="p-1 flex justify-end items-center bg-[#f8f9fa]">
            <div className="flex social-media mx-4">
                <img className="h-10 mx-1" src="/WebLab/facebook.svg" alt="facebook"></img>
                <img className="h-10 mx-1" src="/WebLab/instagram.svg" alt="instagram"></img>
                <img className="h-10 mx-1" src="/WebLab/youtube.svg" alt="youtube"></img>
            </div>
            <Link
